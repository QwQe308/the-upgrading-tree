addLayer("ng", {
    ...
    buyables:{
        11: {
            ...
            unlocked(){return ngSub()||hasMetaUpgrade(15)},
            style(){
    ...
    update(diff){
        if(player.ng.activeChallenge == 11 && !hasUpgrade('u1',52)){
            player.ng.activeChallenge = null
            player.a.points = n(0)
            layerDataReset("ng")
        }
        if(!hasUpgrade('u1',52)) return
